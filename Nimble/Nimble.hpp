...
/** Nimble is used mostly for simple geometric calculations. The code
    is optimized for performance, thus there are a lot of inline
    functions. Also, the vector and matrix classes do not initialize
